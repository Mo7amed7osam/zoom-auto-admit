...
2. Or using dotnet run directly:
   dotnet run --project src/ZoomAutoAdmit.Inspector/ZoomAutoAdmit.Inspector.csproj -- waiting-room-auto-admit

3. Web Engine example:
   dotnet run --project src/ZoomAutoAdmit.Inspector/ZoomAutoAdmit.Inspector.csproj -- waiting-room-auto-admit --engine web --meeting-url "https://zoom.us/j/91473108490"

4. View all commands and options:
   dotnet run --project src/ZoomAutoAdmit.Inspector/ZoomAutoAdmit.Inspector.csproj -- --help
================================================================================
"""
